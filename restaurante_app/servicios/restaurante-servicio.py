...
class RestauranteServicio:
    ...
    # --- OPERACIÓN VENTA (SEMANA 15: Eventos -> Callback -> Servicio -> Persistencia) ---
    def registrar_venta(self, identificacion_usuario: str, codigo_producto: str, cantidad: int) -> Tuple[bool, str]:
        ...
        # 5. Ejecutar la regla de negocio: Descontar stock
        producto.disminuir_stock(cantidad)

        # 6. Generar ID único de Venta
        ...
        # 8. Almacenar en colecciones e índice auxiliar
        self._ventas.append(nueva_venta)
        self._ventas_por_id[id_venta] = nueva_venta

        # 9. Persistir cambios en los archivos JSON
